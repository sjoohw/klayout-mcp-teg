...
- Adapter candidate의 geometry metric별 kind/unit, absolute/relative tolerance, weight와 hard-fail을
  승인·취소하고 exact corpus/compiler에 receipt를 발행하는 host qualification-policy authority.
