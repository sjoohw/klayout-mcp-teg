...
| Pad/corpus onboarding | Source Pad subtree를 수정하지 않는 overlay와 labeled multi-DUT corpus의 coverage/style/variation/holdout score artifact가 있다. | Corpus similarity는 dependency-complete PCell, electrical equivalence 또는 foundry qualification이 아니다. |
